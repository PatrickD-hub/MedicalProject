...
def aruco_display(corners, ids, rejected, image, img_width, img_height):
    if len(corners) > 0:
        ...
        for (markerCorner, markerID) in zip(corners, ids):
            ...
            marker_size_meters = 0.038  # Adjust this value based on the actual size of the marker
            ...
            print(f"Rotation vector (rvec): {quat}")
        ...
        print(f"Distance between: {error: .5f}")
    return image
...
if __name__ == "__main__":
    ...
    while True:
        ...
        markerPosIrFrame = aruco_display(gray, cameraMatrix, markerLength, True)
